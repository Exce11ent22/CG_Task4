        ...
        for(int i = -1; i < 2; i++){
            ...
            for(int j = -1; j < 2; j++){
                ...
                for(int k = -1; k < 2; k++){
                    ...
                    MyPolygon polyRed = new MyPolygon(Color.RED, p5, p7, p8, p6);
                    MyPolygon polyWhite = new MyPolygon(Color.WHITE, p2, p6, p8, p4);
                    MyPolygon polyBlue = new MyPolygon(Color.BLUE, p3, p4, p8, p7);
                    MyPolygon polyGreen = new MyPolygon(Color.GREEN, p1, p5, p6, p2);
